...
In this project, I made a small and simple ASCII game coded in TypeScript and implementing the ECS pattern. You can play it [HERE](https://demos.angrypixel.gg/ecs-poc)
